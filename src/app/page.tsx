  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <footer className="border-t border-slate-100 py-8">
        <div className="mx-auto max-w-5xl px-4 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-slate-400">
          <div className="flex items-center gap-2">
          ...
          <span>&copy; 2026 BrainUP — Barcha huquqlar himoyalangan</span>
        </div>
      </footer>
    </div>
  );
