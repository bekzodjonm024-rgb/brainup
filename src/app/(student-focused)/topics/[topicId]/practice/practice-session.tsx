        ...
        <div className="w-full max-w-xl space-y-4">
          ...
          {phase === "no-questions" && (
            <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 py-12 text-center space-y-4">
              ...
              <Button variant="outline" onClick={() => router.push(`/courses/${courseId}`)} className="border-slate-300 dark:border-slate-700 text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 bg-transparent">
                Kursga qaytish
              </Button>
            </div>
          )}
            ...
            <div className={cn(
              ...
              <div className="flex items-center gap-2">
                <span className={cn("text-xs font-medium rounded-full border px-2.5 py-0.5",
                  DIFF_STYLE[currentQuestion.difficulty] ?? "bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 border-slate-200 dark:border-slate-700"
                )}>
          ...
          {phase === "complete" && (
            <div className="rounded-2xl border border-emerald-500/20 bg-white dark:bg-slate-900 p-8 text-center space-y-5">
              ...
              <div className="flex gap-3">
                ...
                <Button
                  variant="outline"
                  className="border-slate-300 dark:border-slate-700 text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 bg-transparent"
                  onClick={() => {
