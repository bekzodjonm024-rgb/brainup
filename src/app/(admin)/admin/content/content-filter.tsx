...
const TABS = [
  ...
  { key: "DRAFT", label: "Qoralama", activeColor: "text-stone-400 border-slate-500" },
] as const;
...
export function ContentFilter({
  ...
  return (
    <div className="flex items-center gap-1 border-b border-stone-200 dark:border-white/8 pb-0 overflow-x-auto">
          ...
          <button
            ...
            className={cn(
              ...
              isActive
                ...
                : "text-stone-500 dark:text-slate-600 border-transparent hover:text-stone-600 dark:hover:text-slate-400"
            )}
          >
            {label}
            {count > 0 && (
              <span className={cn(
                ...
                isActive
                  ? "bg-slate-200 dark:bg-[#1C1710] text-stone-600 dark:text-slate-300"
                  : "bg-stone-100 dark:bg-[#1C1710] text-stone-500 dark:text-slate-600"
              )}>
                {count}
              </span>
            )}
