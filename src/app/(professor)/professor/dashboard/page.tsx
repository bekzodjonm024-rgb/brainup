    ...
    <div className="flex flex-col flex-1 overflow-auto bg-[#F8F5EF] dark:bg-[#100D09]">
      ...
      <main className="flex-1 p-6 space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[
            { icon: <BookOpen className="h-5 w-5 text-[#B45309] dark:text-amber-400" />,      label: "Kurslar",        value: totalCourses,          iconBg: "bg-[#FEF4E7] dark:bg-amber-950/30" },
          ...
          <Link href="/professor/analytics">
            <div className="rounded-xl border border-violet-200 dark:border-violet-900/50 bg-white dark:bg-[#1C1710] p-5 hover:border-violet-300 dark:hover:border-violet-800 transition-colors h-full flex flex-col justify-between cursor-pointer shadow-sm">
