        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            {professor.courses.length === 0 ? (
              ...
              professor.courses.map((course) => {
                ...
                return (
                  <div key={course.id} className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-5">
                    <div className="flex items-start justify-between gap-4 mb-4">
                      ...
                      <Link href={`/professor/courses/${course.id}`}>
                        <Button size="sm" variant="outline" className="border-slate-300 dark:border-slate-700 text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 bg-transparent shrink-0 text-xs">
          ...
          <div className="space-y-4">
            ...
            {difficultTopics.length === 0 ? (
              ...
              <div className="rounded-2xl border border-amber-500/20 bg-white dark:bg-slate-900 p-5 space-y-4">
