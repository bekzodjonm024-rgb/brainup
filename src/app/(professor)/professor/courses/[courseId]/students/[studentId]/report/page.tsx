...
function masteryColor(score: number | null) {
  if (score === null) return "bg-slate-100 dark:bg-[#1C1710] border border-slate-200 dark:border-white/10 text-slate-500";
  ...
  return (
    <div className="flex flex-col flex-1 overflow-auto bg-[#F8F5EF] dark:bg-[#100D09]">
      ...
      <main className="flex-1 p-6 space-y-6">
        ...
        {/* Student info */}
        <div className="rounded-xl border border-slate-200 dark:border-white/8 bg-white dark:bg-[#17130E] px-5 py-4 flex flex-wrap items-center gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            {student.yearLevel && (
              <span className="text-xs px-2 py-0.5 rounded-full bg-slate-100 dark:bg-[#1C1710] border border-slate-200 dark:border-white/10 text-slate-500 dark:text-slate-400">{student.yearLevel}-kurs</span>
            )}
            {student.groupName && (
              <span className="text-xs px-2 py-0.5 rounded-full bg-slate-100 dark:bg-[#1C1710] border border-slate-200 dark:border-white/10 text-slate-500 dark:text-slate-400">{student.groupName}</span>
            )}
          ...
          <div className="lg:col-span-2">
            <div className="rounded-xl border border-slate-200 dark:border-white/8 bg-white dark:bg-[#17130E] overflow-hidden">
              <div className="px-5 py-4 border-b border-slate-200 dark:border-white/8">
                ...
                <div className="h-1.5 bg-slate-200 dark:bg-[#1C1710] rounded-full overflow-hidden mt-2">
                  <div
