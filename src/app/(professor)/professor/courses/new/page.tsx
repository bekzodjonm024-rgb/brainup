  ...
  return (
    <div className="flex flex-col flex-1 overflow-auto bg-[#F8F5EF] dark:bg-[#100D09]">
      ...
      <main className="flex-1 p-6 max-w-2xl mx-auto w-full">
        <Link href="/professor/courses" className="inline-flex items-center gap-1.5 text-sm text-stone-500 hover:text-stone-700 dark:hover:text-slate-300 mb-6 transition-colors">
          <ArrowLeft className="h-4 w-4" /> Orqaga
        </Link>

        <div className="rounded-xl border border-stone-200 dark:border-white/8 bg-white dark:bg-[#17130E] p-6">
          <div className="mb-6">
            <h2 className="font-semibold text-stone-700 dark:text-slate-200 text-lg">Kurs ma&apos;lumotlari</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label htmlFor="semester" className="text-sm font-medium text-stone-600 dark:text-slate-300">Semester</label>
                <input
                  id="semester"
                  value={form.semester}
              ...
              <div className="space-y-1.5">
                <label className="text-sm font-medium text-stone-600 dark:text-slate-300">Fakultet</label>
                <Select value={form.facultyId} onValueChange={(v) => update("facultyId", v)}>
                  <SelectTrigger className="h-10 border-stone-300 dark:border-white/10 bg-white dark:bg-[#1C1710] text-[#1C1208] dark:text-slate-200">
